...
const translations = {
    tr: {
        ...
        "hci-card-desc": "MBTI/Big Five testi sonucuna göre Llama 3.2 3B (OpenRouter ücretsiz) ile seçilen 8 boyut ile portfolyo anında kişiye özel dönüşür. localStorage ile hatırlanır, tüm proje sayfalarında aktif. HCI akademik projesi.",
    ...
    en: {
        ...
        "hci-card-desc": "Portfolio adapts instantly based on MBTI/Big Five via Llama 3.2 3B (OpenRouter free) — 8 dimensions. Persists in localStorage; active across all project pages. HCI academic project.",
