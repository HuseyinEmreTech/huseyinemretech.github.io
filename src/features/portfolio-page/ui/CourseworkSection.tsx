          ...
          {cards.map((card, idx) => (
            ...
            >
              ...
              <div className="flex justify-between items-start mb-8 relative z-10">
                <div className="p-3 rounded-2xl bg-white/[0.03] border border-white/5 text-white/50 group-hover:text-cyan-400 transition-colors">
              ...
              <a
                href={card.href}
                className="inline-flex items-center gap-2 text-sm font-semibold text-cyan-400 hover:text-cyan-400 transition-colors mt-auto"
              >
                {card.cta}
