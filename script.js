    ...
    const localProjects = [
        {
            ...
            tech: ["Vanilla JS", "OpenRouter / Llama", "Cloudflare Workers"],
            category: "dev",
...
const translations = {
    tr: {
        ...
        "hci-card-desc": "MBTI/Big Five testi sonucuna göre Llama 3.3 70B ile seçilen 8 boyut (tema, layout, CTA, ton, font, animasyon, buton stili, spacing) ile portfolyo anında kişiye özel dönüşür. localStorage ile hatırlanır, tüm proje sayfalarında aktif. HCI akademik projesi.",
    ...
    en: {
        ...
        "hci-card-desc": "Portfolio adapts instantly based on MBTI/Big Five results via Llama 3.3 70B — 8 dimensions (theme, layout, CTA, tone, font, animation, button style, spacing). Persists in localStorage; active across all project pages. HCI academic project.",
